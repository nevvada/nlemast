const post = {
  ...
  markdown: `
      ...
      Fernando Pessoa Where’s your will to be weird? – Jim Morrison Just as it sounds, the word,
      ...
      being, in whatever form, from whatever source, created by a “tulpamancer” Home to many
      underground communities, 4chan was one of the first crossroads where tulpamancers could meet
      ...
      well as countless Q&As addressing every single angle. Here’s my quick rundown of tulpas and
      tulpamancers: Tulpas are created to assist in memory recall, to help get rid of negative
      ...
      basement-dwelling perverts, clutching their Twilight Sprinkle plushies. However, as
      ...
      illness, an effect that could prove highly calamitous to some. But knee-jerk reactions aside,
      ...
      authentic meaning and purpose: if it helps, it helps. In the sage words of George Costanza,
      it’s not a lie…if you believe it. Reddit threads, further reading for the curious:
    </Markdown>
  `,
};
