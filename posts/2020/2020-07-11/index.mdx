...
![file_input](./images/FileInput.png)
...
[Here’s a JSFiddle](https://jsfiddle.net/nlemast/tphw249b/18/) of the above example. Try console logging out the file to see what it looks like!
